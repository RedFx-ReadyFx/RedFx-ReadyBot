...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase() === 'çüş') {
    msg.reply('Lütfen daha az argo kelime kullanalım.');
  }
  ...
  if (msg.content.toLowerCase() === prefix + 'youtube' ) {
    msg.reply('Bot yapımcısı youtube kanalı - ReadyFx')
  }
  if (msg.content.toLowerCase() === prefix + 'bot davet' ) {
    msg.reply('https://discordapp.com/oauth2/authorize?client_id=709852625532616795&scope=bot&permissions=2087971903')
  }
  if (msg.content.toLowerCase() === prefix + 'iletişim' ) {
    msg.reply('Gmail - xreadyfx@gmail.com')
  }
